...
% 
% Winning genotype stored in BestSol.Position
%
...
CostFunction=@pTaxisDistAvg;   % Cost Function

nVar=6;                % Number of Unknown (Decision) Variables

VarSize=[1 nVar];       % Decision Variables Matrix Size

VarMin=-0.05;             % Lower Bound of Decision Variables
VarMax=0.2;             % Upper Bound of Decision Variables
